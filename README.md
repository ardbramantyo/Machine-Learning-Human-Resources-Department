...
### Overview
The project is aimed to develop Machine Learning models and make comparative prediction from employees data (1470 data) that could better predict Employees attrition.
